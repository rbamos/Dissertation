...
\title{Consumer Protection on the Web with Longitudinal Web Crawls and Analysis}
...
% Fix possessive on \citet
\newcommand\cites[1]{\citeauthor{#1}'s\ \cite{#1}}
...
\dedication{To those who are watching out for consumers' rights}
...
\include{chapters/privacypolicies/main}
\include{chapters/reviews/main}
